// 1960s — rows: [name, position, rating, s1, s2, s3]
//   QB:  [passYds, passTD, rushYds]
//   RB:  [rushYds, rushTD, recYds]
//   WR/TE: [recYds, recTD, receptions]
export default {
  "Green Bay Packers": [
    ["Bart Starr", "QB", 88, 2438, 16, 179],
    ["Jim Taylor", "RB", 90, 1474, 19, 354],
    ["Paul Hornung", "RB", 86, 671, 8, 190],
  ...
  "Baltimore Colts": [
    ...
    ["Lenny Moore", "RB", 89, 707, 16, 472],
    ["Raymond Berry", "WR", 90, 1298, 14, 75],
  ...
  "Cleveland Browns": [
    ...
    ["Jim Brown", "RB", 99, 1863, 17, 328],
    ["Gary Collins", "WR", 84, 884, 13, 48],
  ...
  "New York Jets": [
    ...
    ["Don Maynard", "WR", 89, 1434, 10, 71],
    ["George Sauer", "WR", 83, 1189, 6, 75],
  ...
  "Kansas City Chiefs": [
    ...
    ["Otis Taylor", "WR", 88, 1297, 8, 58],
    ["Mike Garrett", "RB", 82, 1087, 9, 269],
  ...
  "Dallas Cowboys": [
    ...
    ["Bob Hayes", "WR", 91, 1232, 13, 64],
    ["Don Perkins", "RB", 80, 768, 6, 111],
  ...
  "Oakland Raiders": [
    ...
    ["Fred Biletnikoff", "WR", 86, 876, 10, 61],
    ["Warren Wells", "WR", 84, 1137, 14, 47],
