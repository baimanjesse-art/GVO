// 1980s — rows: [name, position, rating, s1, s2, s3]
//   QB:  [passYds, passTD, rushYds]
//   RB:  [rushYds, rushTD, recYds]
//   WR/TE: [recYds, recTD, receptions]
export default {
  "San Francisco 49ers": [
    ["Joe Montana", "QB", 97, 3630, 28, 190],
    ["Jerry Rice", "WR", 99, 1570, 17, 86],
    ["Roger Craig", "RB", 90, 1050, 7, 1016],
    ["Dwight Clark", "WR", 84, 900, 6, 60],
    ["Freddie Solomon", "WR", 78, 737, 8, 48],
    ["Brent Jones", "TE", 82, 500, 4, 40],
    ["Wendell Tyler", "RB", 80, 1024, 7, 230],
  ],
  "Miami Dolphins": [
    ["Dan Marino", "QB", 98, 5084, 48, 60],
    ["Mark Clayton", "WR", 89, 1389, 18, 73],
    ["Mark Duper", "WR", 88, 1306, 8, 71],
    ["Tony Nathan", "RB", 78, 558, 3, 452],
    ["Nat Moore", "WR", 80, 573, 6, 43],
    ["Bruce Hardy", "TE", 74, 430, 5, 39],
    ["Andra Franklin", "RB", 76, 746, 7, 100],
  ],
  "Washington Redskins": [
    ["Joe Theismann", "QB", 86, 3714, 29, 234],
    ["John Riggins", "RB", 88, 1347, 24, 108],
    ["Art Monk", "WR", 90, 1372, 6, 106],
  ...
  "Chicago Bears": [
    ...
    ["Walter Payton", "RB", 96, 1551, 9, 483],
    ["Willie Gault", "WR", 82, 704, 1, 33],
  ...
  "San Diego Chargers": [
    ...
    ["Kellen Winslow", "TE", 95, 1290, 9, 89],
    ["John Jefferson", "WR", 86, 1340, 13, 82],
  ...
  "Los Angeles Raiders": [
    ...
    ["Marcus Allen", "RB", 92, 1759, 11, 555],
    ["Todd Christensen", "TE", 88, 1247, 12, 92],
  ...
  "Cincinnati Bengals": [
    ...
    ["Cris Collinsworth", "WR", 86, 1130, 5, 67],
    ["Eddie Brown", "WR", 84, 1273, 9, 53],
  ...
  "Denver Broncos": [
    ...
    ["Sammy Winder", "RB", 78, 789, 9, 197],
    ["Vance Johnson", "WR", 80, 896, 5, 51],
